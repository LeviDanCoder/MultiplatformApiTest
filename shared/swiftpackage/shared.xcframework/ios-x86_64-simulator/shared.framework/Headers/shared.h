...
@class SharedResponse, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedResponseCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
...
@interface SharedApplicationApi : SharedBase
...
*/
- (void)aboutWithCompletionHandler:(void (^)(SharedResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("about(completionHandler:)")));
- (void)aboutCallback:(void (^)(NSString *))callback __attribute__((swift_name("about(callback:)")));
- (SharedKotlinx_coroutines_coreCoroutineDispatcher *)getDispatcher __attribute__((swift_name("getDispatcher()")));
@end
...
- (SharedResponse *)doCopyStatus:(NSString *)status __attribute__((swift_name("doCopy(status:)")));
